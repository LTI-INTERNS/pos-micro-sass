...
const addOrderFields: FieldConfig[] = [
...
export default function AddOrderPopup({ open, onClose, onSave }: AddOrderPopupProps) {
  const [latestValues, setLatestValues] = React.useState<Record<string, string>>({});

  return (
    <ModalShell open={open} title="Add New Order" onClose={onClose} widthClassName="w-[980px] max-w-[92vw]">
