...
// ✅ update this import path to where your popup file is located
...
export default function OrderPaymentModal({
  ...
  // ✅ Discount options (edit these to match your real discounts)
  ...
  () => [
    ...
    { id: "disc_broccoli_staff1", label: "Broccoli Staff (on total)", percent: 50 },
    { id: "disc_better_homes1", label: "Better homes (on total)", percent: 50 },
    { id: "disc_fly_dubai1", label: "Fly Dubai (on total)", percent: 50 }
  ],
  []
);
    ...
    <>
      <div className="fixed inset-0 z-50 flex justify-end bg-black/30">
        <div className="h-full w-[420px] bg-white shadow-xl flex flex-col">
          ...
          <div className="flex-1 overflow-y-auto px-5 py-4 space-y-5">
                  ...
                  return (
                    <button
                      ...
                      onClick={() => {
                        ...
                        // ✅ open popup when Discount selected
                        if (pm.id === "Discount") {
            ...
            {/* Inputs (shown for ALL payment methods) */}
            <div>
              <p className="mb-2 text-sm font-semibold text-black">
                Input amount
              </p>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full h-14 rounded-full border border-gray-400 outline-none focus:border-orange-400
                    text-gray-600 font-semibold placeholder:text-gray-400 placeholder:font-normal
                    ${tipFocused ? "text-left pl-20 pr-5" : "text-center px-5"}
                  `}
                />
              </div>
            </div>

            {/* Keypad (shown for ALL payment methods) */}
      ...
      <DiscountPopup
        ...
        onApply={(selectedId) => {
          ...
          // For now just log (you can calculate later)
          console.log("Discount applied:", selectedId);
        }}
