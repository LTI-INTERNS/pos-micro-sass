        ...
        <table className="w-full text-xs">
          <thead>
            <tr className="border-t border-b border-gray-100 text-gray-500">
              ...
              <th className="px-6 py-2 text-left font-semibold">Pin</th>
            </tr>
          </thead>
          ...
          <tbody>
            {cashiers.map((c) => (
              ...
              >
                ...
                <td className="px-6 py-3 text-gray-700">{c.cashierNo}</td>
                <td className="px-6 py-3 font-semibold text-gray-900">
                  {c.totalRevenue.toLocaleString()}
                </td>
                <td className="px-6 py-3 text-gray-700">{c.email}</td>
                <td className="px-6 py-3 text-gray-700">{c.passwordMasked}</td>
                <td className="px-6 py-3 text-gray-700">{c.pinMasked}</td>
              </tr>
            ))}
