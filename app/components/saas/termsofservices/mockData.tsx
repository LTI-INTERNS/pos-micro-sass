    ...
    content: (
      <>
        <p>
          ...
          cloud-based POS micro-SaaS platform for Retail stores,
  ...
  },
  {
    ...
    content: (
      <ul className="list-disc pl-5 space-y-2">
        ...
        <li>Staff actions are treated as your business actions.</li>
      </ul>
    ),
  },
  {
    ...
    content: (
      <ul className="list-disc pl-5 space-y-2">
        <li>Customer data supports POS operations and receipts.</li>
        <li>
          You must collect customer data lawfully (consent where required).
        </li>
  ...
  },
  {
    ...
    content: (
      <ul className="list-disc pl-5 space-y-2">
        ...
        <li>Late/failed payments may temporarily limit access.</li>
      </ul>
    ),
  },
];
