...
export const privacyItems: AccordionItem[] = [
  {
    ...
    content: (
      <p>
        ...
        This Privacy Policy explains how our POS micro-SaaS platform collects,
        uses, stores, and protects information when used by Retail stores,
  ...
  },
  {
    ...
    content: (
      <ul className="list-disc pl-5 space-y-2">
        ...
        <li>To send service notices (billing, security, updates).</li>
      </ul>
    ),
  },
  {
  ...
  },
  {
    ...
    content: (
      <ul className="list-disc pl-5 space-y-2">
        ...
        <li>You may request export of your data (where supported).</li>
      </ul>
    ),
  },
  {
    ...
    content: (
      <ul className="list-disc pl-5 space-y-2">
        ...
        <li>Monitoring/logging to detect suspicious activity.</li>
      </ul>
    ),
  },
];
